...
export const gridActivity = derived([gridStore, interactionState], ([$grid, $interaction]) => ({
	baseIntensity: $grid.intensity,
	focusPoint: $interaction.hoveredElement ? getElementCenter($interaction.hoveredElement) : null,
