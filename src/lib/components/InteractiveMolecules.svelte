<script lang="ts">
  ...
  import { currentSection, scrollTracker } from '../stores/scroll';
    ...
    'hero-section': [
      {
        ...
        description: 'Contains genetic instructions that influence protein expression and cellular behavior. Methylation patterns can silence or activate genes.',
      ...
      },
      {
        ...
        name: 'Histone H3',
        description: 'Packaging protein that helps organize DNA. Chemical modifications affect gene accessibility and expression patterns.',
    ...
    'problem-section': [
      {
        ...
        description: 'Acute-phase protein indicating systemic inflammation. Elevated levels predict cardiovascular disease risk.',
      ...
      },
      {
        ...
        type: 'protein' as const,
        name: 'Interleukin-6',
        description: 'Pro-inflammatory cytokine that triggers CRP production in the liver. Links cellular stress to systemic inflammation.',
    ...
    'approach-section': [
      {
        ...
        description: 'Probabilistic model connecting molecular observations to biological functions through causal relationships.',
      ...
      },
      {
        ...
        description: 'Algorithm that infers causal relationships by passing probability messages between connected nodes in the factor graph.',
    ...
    'applications-section': [
      {
        ...
        type: 'dna' as const,
        name: 'Telomere',
        description: 'Protective DNA-protein structures at chromosome ends. Shortening predicts cellular aging and disease risk.',
      ...
      },
      {
        ...
        type: 'metabolite' as const,
        name: 'NAD+',
        description: 'Essential coenzyme for cellular energy production and DNA repair. Declining levels are linked to aging processes.',
    ...
    'partnership-section': [
      {
        ...
        description: 'Combining genomic, epigenetic, metabolomic, and proteomic data to build comprehensive causal models.',
      ...
      },
      {
        ...
        description: 'Targeted therapies based on individual molecular causality patterns rather than population averages.',
    ...
    'science-section': [
      {
        ...
        description: 'Technology enabling measurement of molecular states in individual cells, revealing cellular heterogeneity and signaling dynamics.',
      ...
      },
      {
        ...
        description: 'Probabilistic graphical model representing conditional dependencies between variables. Forms the foundation of causal inference.',
    ...
    'closing-cta-section': [
      {
        ...
        description: 'Healthcare guided by individual molecular causality maps, enabling prevention before disease manifests.',
  ...
  const opacitySpring = spring(0, { stiffness: 0.1, damping: 0.8 });
  
  function createMolecules() {
    molecules = [];
    
    Object.entries(moleculeData).forEach(([section, sectionMolecules]) => {
      sectionMolecules.forEach((mol, index) => {
  ...
  function handleMoleculeHover(molecule: Molecule, event: MouseEvent) {
...
>
  {#each molecules as molecule (molecule.id)}
    <div
      ...
      on:mouseenter={(e) => handleMoleculeHover(molecule, e)}
    ...
    >
      ...
      {#if tooltip.molecule.connections.length > 0}
        <div class="connections">
          ...
          <ul>
            {#each tooltip.molecule.connections as connectionId}
