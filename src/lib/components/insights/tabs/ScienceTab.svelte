...
<div class="space-y-6">
	...
	<div class="bg-aeon-surface-1 p-4 rounded-lg">
		...
		<div class="space-y-4">
			...
			<div>
				...
				<div class="space-y-2">
					{#each finding.knowledgeContext.establishedFunctions as func (func)}
			...
			<div>
				...
				<div class="space-y-2">
					{#each finding.knowledgeContext.commonCellularRoles as role (role)}
						<div class="flex items-start gap-2">
							<ChevronsRight class="h-4 w-4 mt-1 text-aeon-primary flex-shrink-0" />
			...
			<div class="space-y-4">
				...
				{#if finding.knowledgeContext.regulatoryNetwork.upstream?.length}
					<div>
						...
						<div class="space-y-2">
							{#each finding.knowledgeContext.regulatoryNetwork.upstream as factor (factor)}
								<div class="flex items-start gap-2">
				...
				{#if finding.knowledgeContext.regulatoryNetwork.downstream?.length}
					<div>
						...
						<div class="space-y-2">
							{#each finding.knowledgeContext.regulatoryNetwork.downstream as effect (effect)}
								<div class="flex items-start gap-2">
									<ChevronsRight class="h-4 w-4 mt-1 text-aeon-primary flex-shrink-0" />
	...
	{#if finding.knowledgeContext.conservedPathways?.length}
		<div class="bg-aeon-surface-1 p-4 rounded-lg">
			...
			<div class="space-y-2">
				{#each finding.knowledgeContext.conservedPathways as pathway (pathway)}
					<div class="flex items-start gap-2">
						<ChevronsRight class="h-4 w-4 mt-1 text-aeon-primary flex-shrink-0" />
