...
<style>
	...
	.grid-pattern::after {
		...
		inset: 0;
		background-image:
			linear-gradient(rgba(128, 255, 219, calc(var(--activity) * 0.12)) 1px, transparent 1px),
			linear-gradient(90deg, rgba(128, 255, 219, calc(var(--activity) * 0.12)) 1px, transparent 1px);
		background-size: var(--scale) var(--scale);
		filter: blur(0.5px);
